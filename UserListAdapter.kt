package com.api.foodapp.adapters
...
class UserListAdapter(var userList:List<UserModel?>):RecyclerView.Adapter<UserListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent:ViewGroup,viewType:Int):ViewHolder {
        var view=LayoutInflater.from(parent.context).inflate(R.layout.row_user_list_layout,parent,false)
